...
class HotSearchAdapter constructor(val data: List<HotSearch>) : RecyclerView.Adapter<HotSearchViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = HotSearchViewHolder(ItemHotSearchBinding.inflate(LayoutInflater.from(parent.context), parent, false))
